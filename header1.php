...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
         <title>PENTA LOGISTICS (XPRESS CARGO)</title>
         <link rel="icon" href="./assets/img/logo/favicon.png" type="image/gif" sizes="16x16">
         <meta charset="UTF-8" />
                     ...
                     <div class="theme-container container">
                         <div class="row">
                             ...
                             <div class="col-md-6 col-sm-7 fs-12">
                                 <p class="contact-num">   <i class="fa fa-phone"></i> Call us now:  <span class="theme-clr">+91 63795 41406  </span>  </p>
                             </div>
                         </div>
                     </div>
                 ...
                 <nav class="menu-bar font2-title1 ">
                     <div class="theme-container container">
                         <div class="row">
                             ...
                             <div class="col-md-8 col-sm-8 fs-12">
                                 <div id="navbar" class="collapse navbar-collapse no-pad">
                                     <ul class="navbar-nav theme-menu">
                                         ...
                                         <li>  <a href="service.php"> Service Areas</a>  </li>
