                         ...
                         <div class="progress-wrap">
                             ...
                             <div class="row progress-content upper-text">
                                 ...
                                 <div class="col-md-4 col-xs-8 col-sm-4 text-center">
                                     ...
                                     <h2 class="title-1 no-margin"><?php $offsql=mysqli_fetch_array(mysqli_query($dbConn,"select * from `city`,`tbl_offices` where tbl_offices.id='".$stsql['current_city']."' and city.b_id=tbl_offices.city and tbl_offices.status='A'"));
						 ...
						 <?php
                             ...
                             <div class="col-md-12 pad-30 wow fadeInLeft" data-wow-offset="50" data-wow-delay=".30s"> 
                                 <div class="prod-info white-clr">
                                     <ul>
                                         <li>  <center>Waybill Number Does Not exist. Please Try with Proper Waybill Numbers</center>  </li>
