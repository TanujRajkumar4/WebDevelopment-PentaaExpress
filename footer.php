                     ...
                     <div class="theme-container container">               
                         <div class="row">
                             <div class="col-md-6 col-sm-6 footer-widget">
                                 <a href="#">  <img class="logo" alt="#" src="assets/img/logo/logo-2.png" />   </a>
                             </div>
                     ...
                     <div class="theme-container container">               
                         <div class="row">
                             <div class="col-md-6 col-sm-6">
                                 <p> © Copyright <?php echo date('Y');?>, All rights reserved by PENTA LOGISTICS (XPRESS CARGO) </p>                            
                             </div>
                             <div class="col-md-6 col-sm-6 text-right">
                                 <p> Developed  <span class="theme-clr fa fa-heart"></span>  by  <a href="https://www.shakthisoftsolutions.com" class="main-clr"> Shakthisoftsolutions  </a>  </p>
                             </div>
                         </div>
                     </div>
                 </div>
             ...
             <div class="modal-dialog modal-md">                
                 ...
                 <div class="modal-content">   
                     <div class="login-wrap text-center">                        
                         ...
                         <p> Sign in to  <strong> GO  </strong> for getting all _______  </p>                        
                     ...
                     <div class="create-accnt">
                         <a href="#" class="white-clr"> Don’t have an _______?  </a>  
