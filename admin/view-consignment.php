											...
											<tbody>
												<tr>
													...
													if ($_SESSION['uid'] == 10) {
														...
														$SQL = "SELECT * from tbl_courier where status='A' AND (dest_off=$_SESSION[uid] OR org_off=$_SESSION[uid]) ORDER BY waybillno DESC";
													}
													...
													<form id="UpdateConsignment" action="UpdateConsignment.php" method="POST">
														...
														?>
															...
															<td class="hidden-480 center">
																...
																<a onclick="return confirm('Are you sure want to delete?');" href="add-consignment.php?ty=del&delid=<?php echo $row[1]; ?>">
