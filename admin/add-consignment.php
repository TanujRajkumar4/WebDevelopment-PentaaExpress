													...
													<div class="step-pane active" >
														...
														<form class="form-horizontal" method="POST" action="add-consignment.php?ac=ins&ty=<?php echo $_GET['ty'];?>">
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="consignor" id="consignor" class="col-xs-12 col-sm-6" />
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<textarea class="input-xlarge" name="cusAddrs" id="cusAddrs"></textarea>
																	</div>
																</div>
															</div>

																<h3 class="lighter block green">Consignee's Details</h3><div class="hr hr-dotted"></div>
																<div class="form-group">
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="consignor">Consignee's Name:</label>

																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="Consignee" id="Consignee" class="col-xs-12 col-sm-6" />
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="input-group">
																		...
																		<input type="tel" id="consigneephone" name="consigneephone" />
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<textarea class="input-xlarge" name="consigneeAddrs" id="consigneeAddrs"></textarea>
																	</div>
																</div>
															</div>
															<h3 class="lighter block green">Consignment Details</h3><div class="hr hr-dotted"></div>
															<div class="form-group">
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="waybillno">Waybill No:</label>

																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="waybillno" id="waybillno" class="col-xs-12 col-sm-6" onloadstart="this.focus();" onmouseover="this.focus();" />
																	</div>
															</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="boxpkg" id="boxpkg" value="0.00" placeholder="Price Per Kg / Box" required />
																	</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="number" name="qty" id="qty" class="col-xs-12 col-sm-3 " readonly />
																	</div>
								...
								<form class="form-horizontal" method="POST" action="add-consignment.php?ac=upd&ty=edit&editid=<?php echo $_GET['editid'];?>">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<select class="col-xs-12 col-sm-5" id="desoff" name="desoff">
																			...
																			<?php if($rwtoi['id'] == $rowms['dest_off']){echo "selected";}?>
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<select class="col-xs-12 col-sm-3" id="contyp" name="contyp">
																			...
																			<?php if($rwtoi['b_id'] == $rowms['toi']){echo "selected";}?>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div>
																		<label class="line-height-1 blue">
																			<input name="gender" value="1" id="Wgt" type="radio" class="ace" onclick="enableTextbox()" <?php if($rowms['weight']== 1){echo "checked"; $blk="block";}?>/>
																			<span class="lbl"> Weight</span>
																		</label>
																	</div>
																	<div>
																		<label class="line-height-1 blue">
																			<input name="gender" value="2" id="Boxrt" type="radio" class="ace" onclick="enableTextbox()" <?php if($rowms['weight']== 2){echo "checked"; $blk="block";}?>/>
																			<span class="lbl"> Box Rate</span>
																		</label>
																	</div>
																</div>
															...
															<div id="ActWgt" style="display: <?php if($rowms['weight'] != 1){echo "none";}?>;/>">
															<div class="space-2"></div>
															<div class="form-group">
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="actualwgt">Actual Weight:</label>
															...
															<div id="BoxWgt" style="display: <?php if($rowms['weight'] != 2){echo "none";}?>;">
															<div class="space-2"></div>
															<div class="form-group">
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="actualwgt">Boxes:</label>
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<select class="input-medium " id="uom" name="uom">
																			...
																			?>
																			<option value="<?php echo $rwtoi['b_id'];?>"
																			<?php if($rwtoi['b_id'] == $rowms['units']){echo "selected";}?>
																			><?php echo $rwtoi['bname'];?></option>
																			<?php
																			}
																			?>
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<select class="input-medium" id="platform" name="platform">
																			...
																			?>
																			<option value="<?php echo $rwtoi['b_id'];?>"
																			<?php if($rwtoi['b_id'] == $rowms['pay_mode']){echo "selected";}?>
																			><?php echo $rwtoi['bname'];?></option>
																			<?php
																			}
																			?>
															...
															<div class="form-group" id="paysec" style="display:<?php if($rowms['pay_mode'] == 1){ echo "block";}else{echo "none";}?>";>
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="topay">To Pay Charges:</label>
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<select class="col-xs-12 col-sm-5" id="book_status" name="book_status">
																			...
																			?>
																			<option value="<?php echo $rwtoi['b_id'];?>" 
																			<?php if($rwtoi['b_id'] == $rowms['book_status']){echo "selected";}?> ><?php echo $rwtoi['bname'];?></option>
																			<?php
																			}
																			?>
																		</select>
