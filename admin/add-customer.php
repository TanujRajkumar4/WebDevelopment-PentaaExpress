	...
	if(isset($_GET['ty']))
	{
		...
		if(isset($_GET['ac']))
		{
			...
			if($_GET['ac'] =="repay")
			{
				...
				{
					echo "<script>alert('Not Inserted');window.location.href = 'add-customer.php?ty=add';</script>";
				}
												...
												<div class="step-content pos-rel">
													<div class="step-pane active" >
														...
														<form class="form-horizontal" method="POST" action="add-customer.php?ac=ins&ty=<?php echo $_GET['ty'];?>">
															...
															<h3 class="lighter block green">Charges Details</h3><div class="hr hr-dotted"></div>
							...
							<div class="col-xs-12">
								...
								<form class="form-horizontal" method="POST" action="add-customer.php?ac=repay&ty=repay&editid=<?php echo $_GET['editid'];?>">
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="outstanding" id="outstanding" class="col-xs-12 col-sm-6" value="<?php echo $rowms['bala'];?>" readonly />
																	</div>
																</div>
															</div>
